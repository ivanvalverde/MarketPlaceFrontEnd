    ...
    <Form className="formClient">
      ...
      <section className="inputs">
        <Form.Group controlId="formBasicNameClient" className="groupName">
          <Form.Control onChange={handleFormNome} type="text" placeholder="Nome Completo" required />
        </Form.Group>
        ...
        <Form.Group controlId="formBasicCPFClient" className="groupCPF">
          <Form.Control onChange={handleFormCpf} type="text" placeholder="CPF" pattern="/^\d{3}\.\d{3}\.\d{3}\-\d{2}$/" title="Formato: 999.999.999-99" required />
        </Form.Group>
        ...
        <Form.Group controlId="formBasicPasswordClient" className="groupPassword">
          <Form.Control onChange={handleFormSenha} type="password" placeholder="Senha" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
